      ...
      <main className={"px-16"}>
        <div className={"text-center mt-12"}>
          <h1 className={"text-2xl"}>
            あなたの文章を<span className={"dot-text"}>い</span>
            <span className={"dot-text"}>い</span>
            <span className={"dot-text"}>感</span>
            <span className={"dot-text"}>じ</span>に変換します
          </h1>
        </div>
        <div className={"mt-16 flex flex-row justify-center space-x-16"}>
          <div className={"w-1/2"}>
            <h2 className={"text-2xl text-center font-semibold"}>Before</h2>
            <div className={"mt-8 p-12 text-box"}>
              <textarea
                placeholder="テキストを入力してください"
                className={
                  "w-full h-36 text-lg border-2 border-gray-200 focus:border-gray-300"
                }
              ></textarea>
            </div>
          </div>
          <div className={"w-1/2"}>
            ...
            <div className={"mt-8 p-12 text-box"}>
              <textarea
                ...
                readOnly={true}
                className={"w-full h-36 text-lg border-2 border-gray-200"}
              ></textarea>
            </div>
          </div>
        </div>
